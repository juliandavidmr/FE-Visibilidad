...
import ListarTipoActividadComponent from '../../../../components/Dashboard/Childrens/TipoActividad/ListarTipoActividad.component.jsx';
import * as SubpermisoActions from '../../../../actions/subpermisos.js';

class ListarTipoActividad extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div>
        ...
        <ListarTipoActividadComponent tabla_datos={this.state.tabla_datos} />
      </div>
    );
  }
}
