          ...
          <div className="col-md-12">
            ...
            <div className="collapse navbar-collapse" id="navbar-collapse1">
              <form className="navbar-form pull-left">
                <div className="input-group" style={{maxwidth:470}}>
          ...
          <div className="col-md-12">
            <div className="navbar-header">
              ...
              <ul className="nav dropdown-menu">
                <li>
                  <a href="#">
                    <i className="glyphicon glyphicon-user" style={{color:'#1111dd'}}></i>
                    Profile</a>
                </li>
                <li>
                  <a href="#">
                    <i className="glyphicon glyphicon-dashboard" style={{color:'#0000aa'}}></i>
                    Dashboard</a>
                </li>
                <li>
                  <a href="#">
                    <i className="glyphicon glyphicon-inbox" style={{color:'#11dd11'}}></i>
                    Pages</a>
                </li>
                <li className="nav-divider"></li>
                <li>
                  <a href="#">
                    <i className="glyphicon glyphicon-cog" style={{color:'#dd1111'}}></i>
                    Settings</a>
                </li>
                <li>
                  <a href="#">
